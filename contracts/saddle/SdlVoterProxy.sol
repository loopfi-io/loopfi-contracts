...
contract SdlVoterProxy {
    ...
    address public constant mintr =
        address(0x358fE82370a1B9aDaE2E3ad69D6cF9e503c96018);
    ...
    address public constant gaugeController =
        address(0x99Cb6c36816dE2131eF2626bb5dEF7E5cc8b9B14);
    ...
    function claimSdl(address _gauge) external returns (uint256) {
        require(msg.sender == operator, "!auth");

        uint256 _balance = 0;
        try IMinter(mintr).mint(_gauge) {
            _balance = IERC20(sdl).balanceOf(address(this));
            IERC20(sdl).safeTransfer(operator, _balance);
        } catch {}
