...
/*
LPF Locking contract for https://loopfi.io/
LPF locked in this contract will be entitled to voting rights for the Loopfi platform
Based on CVX Locking contract - https://github.com/convex-eth/platform/blob/main/contracts/contracts/CvxLockerV2.sol
*/
contract LpfLocker is ReentrancyGuard, Ownable {
    ...
    constructor(
        ...
        _name = "Vote Locked LoopFi Token";
        _symbol = "vlLPF";
        _decimals = 18;
